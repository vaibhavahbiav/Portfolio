...
function tellMe(joke){
    ...
    VoiceRSS.speech({
        key: '1369008e89ce4c3a800c8c3d412e6095',
        src: joke,
        hl: 'en-in',
        r: 0,
        c: 'mp3',
...
async function getJokes(){
    let joke = '';
    const apiUrl= 'https://v2.jokeapi.dev/joke/Miscellaneous,Pun?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
    try{
